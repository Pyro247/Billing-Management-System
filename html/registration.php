...
<body>
    ...
    <div class="popup-validator" id="popup-id">
        ...
        <form action="/html/registration.html">
            ...
            <p onclick="valid_id_num()">Already have an account? <a href="/index.html">Login Here</a></p>
        </form>
    </div>


    <!-- ETONAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA -->
    
        
            
    <div class="container hide" id="container__id">
    <form action="" class="shadow-lg p-3 mb-2 bg-body rounded" name="myForm">
        <h3>Register - 2018300366 - Student</h3>
    ...
    <div class="step_one" id="step_three_id">
        ...
        <div class="row">
            <div class="col-sm-1 offset-10 mb-5" ><button type="button" class="btn btn-outline-danger btn_nxt_prv" id="previous_id" onclick="prev_tab()">Previous</button></div>
            <div class="col-sm-1 "><button type="button" class="btn btn-outline-success btn_nxt_prv" id="next_id" onclick="next_tab(), check_if_firststep()">Next</button></div>
        </div>
</div>
    ...
    <script type="text/javascript">
    const popupbox = document.getElementById('popup-id'); 

    function valid_id_num(){
