                              ...
                              <div class="row g-2 mb-1"> <!-- PROGRAM MAJOR FEE----->
                                <div class="col-md">
                                  <div class="form-floating">
                                    ...
                                    <select class="form-select" name="stud_college" id="floatingSelect" aria-label="Floating label select example">
                                ...
                                <div class="col-md">
                                  <div class="form-floating">
                                    <input type="email" name="stud_email" class="form-control text-primary" style="font-weight: bold;" id="floatingInputGrid" placeholder=" " value="">
