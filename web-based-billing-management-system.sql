...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2021 at 02:18 AM
...
(2020, 'Mike Isla', 'isla.michael.estrecho@gmail.com', 'Mike', 'Cashier'),
(10121314, 'Mike Isla', 'isla.michael.estrecho@gmail.com', 'Mike', 'Cashier'),
(10121315, 'Denver Pulido', 'pulido@gmail.com', 'pulido', 'Cashier'),
(10121316, 'Justine Delos Reyes', 'justine@gmail.com', 'justine', 'Cashier'),
(10121317, 'Marry Villano', 'villano@gmail.com', 'vilaano', 'Cashier'),
(10121318, 'Mike Isla', 'isla.michael.estrecho@gmail.com', 'Mike', 'Cashier'),
(10121319, 'Mike Isla', 'isla.michael.estrecho@gmail.com', 'Mike', 'Cashier'),
(10121320, 'Mike Isla', 'isla.michael.estrecho@gmail.com', 'Mike', 'Cashier'),
(10121321, 'Mike Isla', 'isla.michael.estrecho@gmail.com', 'Mike', 'Cashier');
...
('', 2018301301, 'Cashier', 'Michael', 'Isla', 'Estrecho', 'Filipino', 'Single', 'male', '2021-09-22', 21, 'isla.michael.estrecho@gmail.com', '09307078204', '');
...
CREATE TABLE `tbl_student_info` (
  `reg_no` varchar(50) NOT NULL DEFAULT 'N/A',
...
INSERT INTO `tbl_student_info` (`reg_no`, `stud_id`, `firstname`, `lastname`, `middlename`, `sex`, `birthdate`, `age`, `address`, `religion`, `citizenship`, `civil_status`, `college`, `major`, `year&section`, `email`, `contact_number`, `reg_date`) VALUES
('N/A', 2018301302, 'Mylene', 'Isla', 'Estrecho', 'female', 'Nov 5,2002', 18, 'Pangasinan', 'Catholic', 'Filipino', 'Single', 'DUMMSU', 'SCIENCE', 'WOW1', 'mylene@gmail.com', '12345', 'N/A');
...
CREATE TABLE `tbl_student_school_details` (
  `stud_id` int(20) NOT NULL,
  `psi_college_type` longtext NOT NULL,
  `psi_college_name` longtext NOT NULL,
  `psi_college_address` longtext NOT NULL,
  `psi_zipcode` int(100) NOT NULL,
  `psi_school_year` varchar(100) NOT NULL,
  `psi_semester` varchar(100) NOT NULL,
  `psi_scholarship` varchar(100) NOT NULL,
  `psi_course` varchar(255) NOT NULL,
  `psi_major` longtext NOT NULL,
  `psi_year` varchar(100) NOT NULL,
