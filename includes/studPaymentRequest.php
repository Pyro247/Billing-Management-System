<?php
  ...
  if(isset($_POST['submitRequest'])){
    ...
    $slq ="INSERT INTO `tbl_pending_payments`(`transaction_no`, `stud_id`, `fullname`, `email`, `amount`, `payment_gateway`, `sales_invoice`, `transaction_date`, `status`, `reasonToDeny`, `cashier_id`, `cashier_name`) VALUES (?,?,?,?,?,?,?,?,?,'',0,'')";
